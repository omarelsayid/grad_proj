...
final mockLearningItems = <LearningItem>[
  // ── Python / Data Science ─────────────────────────────────────────────────────
  const LearningItem(
    id: 'li01', title: 'Python for Data Science & AI', skillId: 'sk01',
  ...
  const LearningItem(
    id: 'li_a01', title: 'Python Data Science Handbook', skillId: 'sk01',
  ...
  // ── Machine Learning ──────────────────────────────────────────────────────────
  const LearningItem(
    id: 'li02', title: 'Machine Learning Specialization', skillId: 'sk02',
  ...
  const LearningItem(
    id: 'li_a02', title: 'Machine Learning Glossary & Cheat Sheet', skillId: 'sk02',
  ...
  // ── Deep Learning ─────────────────────────────────────────────────────────────
  const LearningItem(
    id: 'li03', title: 'Deep Learning Specialization', skillId: 'sk03',
  ...
  // ── SQL ───────────────────────────────────────────────────────────────────────
  const LearningItem(
    id: 'li04', title: 'SQL for Data Analysis', skillId: 'sk04',
  ...
  const LearningItem(
    id: 'li19', title: 'Advanced SQL & Performance Tuning', skillId: 'sk04',
  ...
  const LearningItem(
    id: 'li_a03', title: 'Use The Index, Luke — SQL Indexing Guide', skillId: 'sk04',
  ...
  // ── React / Frontend ──────────────────────────────────────────────────────────
  const LearningItem(
    id: 'li05', title: 'React Basics Certification', skillId: 'sk07',
  ...
  // ── JavaScript ────────────────────────────────────────────────────────────────
  const LearningItem(
    id: 'li16', title: 'Advanced JavaScript Concepts', skillId: 'sk06',
  ...
  const LearningItem(
    id: 'li17', title: 'TypeScript: The Complete Developer\'s Guide', skillId: 'sk06',
  ...
  const LearningItem(
    id: 'li_a04', title: 'JavaScript: The Definitive Guide (MDN)', skillId: 'sk06',
  ...
  const LearningItem(
    id: 'li25', title: 'Git Advanced Workflows', skillId: 'sk06',
  ...
  // ── Node.js / Backend ─────────────────────────────────────────────────────────
  const LearningItem(
    id: 'li06', title: 'Complete Node.js Developer Course', skillId: 'sk08',
  ...
  const LearningItem(
    id: 'li18', title: 'Node.js Microservices Architecture', skillId: 'sk08',
  ...
  const LearningItem(
    id: 'li24', title: 'REST API Design Best Practices', skillId: 'sk08',
  ...
  const LearningItem(
    id: 'li_a05', title: 'Node.js Best Practices Guide', skillId: 'sk08',
    type: LearningType.article, duration: '10 min read', estimatedHours: 0, priority: 2,
  ...
  // ── DevOps / Docker ───────────────────────────────────────────────────────────
  const LearningItem(
    id: 'li07', title: 'Docker & Kubernetes: The Complete Guide', skillId: 'sk12',
  ...
  const LearningItem(
    id: 'li20', title: 'Docker & CI/CD Pipelines with GitHub Actions', skillId: 'sk12',
    type: LearningType.course, duration: '40 hours', estimatedHours: 40, priority: 1,
  ...
  const LearningItem(
    id: 'li_a06', title: 'Docker Overview — Official Docs', skillId: 'sk12',
  ...
  // ── AWS / Cloud ───────────────────────────────────────────────────────────────
  const LearningItem(
    id: 'li08', title: 'AWS Cloud Practitioner Essentials', skillId: 'sk14',
  ...
  // ── Agile / Scrum ─────────────────────────────────────────────────────────────
  const LearningItem(
    id: 'li09', title: 'Project Management Professional (PMP) Prep', skillId: 'sk15',
  ...
  const LearningItem(
    id: 'li10', title: 'Agile Scrum Master Certification (PSM I)', skillId: 'sk16',
  ...
  const LearningItem(
    id: 'li21', title: 'Scrum Master Preparation Practice Tests', skillId: 'sk16',
    type: LearningType.course, duration: '20 hours', estimatedHours: 20, priority: 1,
  ...
  const LearningItem(
    id: 'li_a07', title: 'The Agile Manifesto Explained', skillId: 'sk16',
  ...
  const LearningItem(
    id: 'li11', title: 'Leadership & Mentorship Program', skillId: 'sk17',
  ...
  const LearningItem(
    id: 'li22', title: 'Algorithms & Data Structures in Python', skillId: 'sk20',
  ...
  const LearningItem(
    id: 'li23', title: 'Inspiring and Motivating Individuals', skillId: 'sk19',
  ...
  // ── Flutter / Mobile ──────────────────────────────────────────────────────────
  const LearningItem(
    id: 'li12', title: 'Flutter & Dart — The Complete Guide', skillId: 'sk09',
  ...
  // ── UI/UX Design ─────────────────────────────────────────────────────────────
  const LearningItem(
    id: 'li13', title: 'Google UX Design Certificate', skillId: 'sk27',
    type: LearningType.certification, duration: '30 hours', estimatedHours: 30, priority: 2,
  ...
  // ── Cybersecurity ─────────────────────────────────────────────────────────────
  const LearningItem(
    id: 'li14', title: 'CompTIA Security+ Certification Prep', skillId: 'sk28',
  ...
  // ── HR Analytics ─────────────────────────────────────────────────────────────
  const LearningItem(
    id: 'li15', title: 'HR Analytics with Python — Capstone Project', skillId: 'sk22',
  ...
  const LearningItem(
    id: 'li_a08', title: 'People Analytics: Using Data to Drive HR Decisions', skillId: 'sk22',
